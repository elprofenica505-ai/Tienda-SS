...
function ContactsContent() {
  ...
  const [form, setForm] = useState({ name: '', email: '', phone: '', taxId: '', address: '', notes: '', creditLimit: '0' });
