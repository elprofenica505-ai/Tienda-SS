...
const roleDescriptions: Record<string, string> = {
  admin: 'Administra usuarios, permisos y toda la operación.',
  gerente: 'Supervisa resultados, finanzas, reportes y decisiones del negocio.',
  supervisor_sucursal: 'Coordina una sucursal y valida la operación diaria.',
  vendedor: 'Gestiona clientes, ventas, pedidos y cuentas por cobrar.',
  cajero: 'Opera caja, cobros, ventas y movimientos de efectivo.',
  bodega: 'Controla inventario, existencias y movimientos de almacén.',
  compras: 'Gestiona proveedores, compras, costos y reposición.',
  chofer: 'Consulta pedidos y coordina entregas asignadas.',
  despachador: 'Prepara pedidos, salidas y coordinación de despacho.',
  solo_lectura: 'Consulta información y reportes sin modificar datos.',
  jefe: 'Perfil heredado con control operativo amplio.',
};
