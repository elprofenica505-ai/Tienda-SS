...
const summary = { baseUrl, path, total, concurrency, ok, failed: total - ok, successRate: Number((ok / total).toFixed(4)), p50Ms: percentile(.5), p95Ms: percentile(.95), maxMs: durations.at(-1) || 0, threshold: { minSuccessRate: .99, maxP95Ms: 1000 }, passed: ok / total >= .99 && percentile(.95) <= 1000 };
